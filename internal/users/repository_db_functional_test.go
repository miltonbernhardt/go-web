...
func Test_DB_Tx_GetAll_Success(t *testing.T) {
...
//func Test_DB_Tx_GetAll_Fail(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
func Test_DB_Tx_Delete_Success(t *testing.T) {
	db, mockDB, _ := sqlmock.New()
	defer func(db *sql.DB) {
		_ = db.Close()
	}(db)
...
//func Test_DB_Tx_Delete_Fail_Prepare(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
//}
//
//func Test_DB_Tx_Delete_Fail_Exec(t *testing.T) {
//	db, mockDB, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
func Test_DB_Tx_Update_Success(t *testing.T) {
...
//func Test_DB_Tx_Update_Fail_Prepare(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
//}
//
//func Test_DB_Tx_Update_Fail_Exec(t *testing.T) {
//	query := `UPDATE users SET firstname = \?, lastname = \?, email = \?, age = \?, height = \?, active = \?, created_at = \? WHERE id = \?`
//	db, mockDB, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
...
func Test_DB_Tx_UpdateUserAgeLastname_Success(t *testing.T) {
...
//func Test_DB_Tx_UpdateUserAgeLastname_Fail_Prepare(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
//}
//
//func Test_DB_Tx_UpdateUserAgeLastname_Fail_Exec(t *testing.T) {
//	query := `UPDATE users SET lastname = \?, age = \? WHERE id = \?`
//
//	db, mockDB, _ := sqlmock.New()
//	defer func(db *sql.DB) {
...
func Test_DB_Tx_UpdateUserFirstname_Success(t *testing.T) {
...
//func Test_DB_Tx_UpdateUserFirstname_Fail_Prepare(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
//}
//
//func Test_DB_Tx_UpdateUserFirstname_Fail_Exec(t *testing.T) {
//	query := `UPDATE users SET firstname = \? WHERE id = \?`
//
//	db, mockDB, _ := sqlmock.New()
//	defer func(db *sql.DB) {
...
func Test_DB_Tx_Store_Success(t *testing.T) {
...
//func Test_DB_Tx_Store_Fail_Prepare(t *testing.T) {
//	db, _, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
...
//}
//
//func Test_DB_Tx_Store_Fail_Exec(t *testing.T) {
//	db, mockDB, _ := sqlmock.New()
//	defer func(db *sql.DB) {
//		_ = db.Close()
//	}(db)
